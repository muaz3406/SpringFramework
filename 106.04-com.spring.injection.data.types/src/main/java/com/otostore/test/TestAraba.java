...
public class TestAraba {
	...
	public static void main(String[] args) {
		...
		Toros toros2 = (Toros) applicationContext.getBean("toros");
		System.out.println(toros2);
		
		Toros toros3 = (Toros) applicationContext.getBean("toros");
		System.out.println(toros3);
